...
class __TwigTemplate_ae9881cb2476e0087b3172502dea969fce0b210a4d4fecd7a43551a7328238cf extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap/templates/input/input--button.html.twig", "C:\\xampp\\htdocs\\d9composer\\web\\themes\\bootstrap\\templates\\input\\input--button.html.twig");
    }
